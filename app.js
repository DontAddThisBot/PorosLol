...
app.get('/leaderboard', (req, res) => {
	bot.DB.poroCount.find({}).exec(function (err, kekw) {
		...
		const topUsers = kekw.sort((a, b) => b.poroPrestige - a.poroPrestige || b.poroCount - a.poroCount).slice(0, 10)
...
app.get('/channel', async (req, res) => {
	...
	const myRank = poroData.sort((a, b) => b.poroPrestige - a.poroPrestige || b.poroCount - a.poroCount).findIndex((user) => user.username == req.query.user.toLowerCase()) + 1
	res.render('channel', {
		xd: kekw2,
